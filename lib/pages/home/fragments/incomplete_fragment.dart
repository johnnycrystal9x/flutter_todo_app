...
class _ViewModel {
  ...
  static _ViewModel fromStore(Store<AppState> store) {
    ...
    return _ViewModel(
      todoList: incompleteTodoListSelector(_state),
...
class IncompleteFragment extends StatefulWidget {
  @override
  _IncompleteFragmentState createState() => _IncompleteFragmentState();
}

class _IncompleteFragmentState extends State<IncompleteFragment> {
  @override
  Widget build(BuildContext context) {
    return Center(
      child: StoreConnector<AppState, _ViewModel>(
        onInit: (store) => store.dispatch(LoadIncompleteTodoListAction()),
